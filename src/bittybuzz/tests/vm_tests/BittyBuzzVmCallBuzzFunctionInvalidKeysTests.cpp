...
#include <call_buzz_function_invalidKeys_bytecode.h>
#include <call_buzz_function_invalidKeys_string.h>
#include <gmock/gmock.h>

TEST_F(BittyBuzzVmTestFixture, BittyBuzzVm_callBuzzFunction_sendToHost_invalidKeys) {
    // Given
    uint16_t boardId = 42;
