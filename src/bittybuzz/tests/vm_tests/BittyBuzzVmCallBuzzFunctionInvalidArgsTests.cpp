...
#include <call_buzz_function_invalidArgs_bytecode.h>
#include <call_buzz_function_invalidArgs_string.h>
#include <gmock/gmock.h>

TEST_F(BittyBuzzVmTestFixture, BittyBuzzVm_callBuzzFunction_invalidArgs) {
    // Given
    uint16_t boardId = 42;
