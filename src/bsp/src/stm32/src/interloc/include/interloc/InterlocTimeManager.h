...
#define FINAL_PROCESSING_GUARD 2000U // TODO: Measure time to compute angle + distance
#define RX_BEFORE_TX_GUARD_US 10U
#define TIMEOUT_GUARD_US 100U
#define DEAD_TIME 200U
#define ANGLE_TO_ANGLE_GUARD 550U
#define FINAL_TO_ANGLE_GUARD 1000U

#define NUM_ANGLE_MSG_RECEIVER (10U)
#define NUM_ANGLE_MSG_SENDER (10U)
