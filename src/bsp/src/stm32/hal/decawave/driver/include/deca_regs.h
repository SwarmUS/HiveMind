...
#define DEV_ID_MODEL_MASK                                                                          \
    0x0000FF00UL /* The MODEL identifies the device. The DW1000 is device type 0x01 */
...
/*offset 0 */
#define SYS_CFG_FFE                                                                                \
    0x00000001UL /* Frame Filtering Enable. This bit enables the frame filtering functionality */
...
#define SYS_CFG_FFA4                                                                               \
    0x00000080UL /* Frame Filtering Allow frames with frame type field of 4, (binary 100) */
/*offset 8 */
#define SYS_CFG_FFA5                                                                               \
    0x00000100UL /* Frame Filtering Allow frames with frame type field of 5, (binary 101) */
...
#define SYS_CFG_FCS_INIT2F                                                                         \
    0x00008000UL /* initial seed value for the FCS generation and checking function */
/*offset 16 */
...
#define SYS_CFG_RXAUTR                                                                             \
    0x20000000UL /* Receiver Auto-Re-enable. This bit is used to cause the receiver to re-enable   \
                    automatically */
...
#define TX_FCTRL_TXPSR_MASK                                                                        \
    0x000C0000UL /* bit mask to access Transmit Preamble Symbol Repetitions (PSR). */
#define TX_FCTRL_PE_MASK 0x00300000UL /* bit mask to access Preamble Extension */
#define TX_FCTRL_TXPSR_PE_MASK                                                                     \
    0x003C0000UL /* bit mask to access Transmit Preamble Symbol Repetitions (PSR). */
...
#define TX_FCTRL_PE_SHFT                                                                           \
    (20) /* shift to access Preamble length Extension to allow specification of non-standard       \
            values */
...
#define TX_FCTRL_TXBOFFS_MASK                                                                      \
    0xFFC00000UL /* bit mask to access Transmit buffer index offset 10-bit field */
/*offset 32 */
...
#define SYS_CTRL_MASK_32                                                                           \
    0x010003CFUL /* System Control Register access mask (all unused fields should always be writen \
                    as zero) */
/*offset 0 */
...
#define SYS_CTRL_TXDLYS                                                                            \
    0x00000004UL /* Transmitter Delayed Sending (initiates sending when SYS_TIME == TXD_TIME */
#define SYS_CTRL_CANSFCS                                                                           \
    0x00000008UL /* Cancel Suppression of auto-FCS transmission (on the current frame) */
#define SYS_CTRL_TRXOFF                                                                            \
    0x00000040UL /* Transceiver Off. Force Transciever OFF abort TX or RX immediately */
...
#define SYS_CTRL_RXDLYE                                                                            \
    0x00000200UL /* Receiver Delayed Enable (Enables Receiver when SY_TIME[0x??] == RXD_TIME[0x??] \
                    CHECK comment*/
/*offset 16 */
/*offset 24 */
#define SYS_CTRL_HSRBTOGGLE                                                                        \
    0x01000000UL /* Host side receiver buffer pointer toggle - toggles 0/1 host side data set      \
                    pointer */
...
#define SYS_MASK_MASK_32                                                                           \
    0x3FF7FFFEUL /* System Event Mask Register access mask (all unused fields should always be     \
                    writen as zero) */
/*offset 0 */
...
#define SYS_STATUS_MASK_32                                                                         \
    0xFFF7FFFFUL /* System event Status Register access mask (all unused fields should always be   \
                    writen as zero) */
/*offset 0 */
...
#define SYS_STATUS_TXFRS                                                                           \
    0x00000080UL /* Transmit Frame Sent: This is set when the transmitter has completed the        \
                    sending of a frame */
/*offset 8 */
...
#define SYS_STATUS_TXERR                                                                           \
    (0x0408) /* These bits are the 16 high bits of status register TXPUTE and HPDWARN flags */

/* All RX events after a correct packet reception mask. */
#define SYS_STATUS_ALL_RX_GOOD                                                                     \
    (SYS_STATUS_RXDFR | SYS_STATUS_RXFCG | SYS_STATUS_RXPRD | SYS_STATUS_RXSFDD |                  \
...
#define SYS_STATUS_ALL_TX                                                                          \
    (SYS_STATUS_AAT | SYS_STATUS_TXFRB | SYS_STATUS_TXPRS | SYS_STATUS_TXPHS | SYS_STATUS_TXFRS)
...
#define RX_FINFO_MASK_32                                                                           \
    0xFFFFFBFFUL /* System event Status Register access mask (all unused fields should always be   \
                    writen as zero) */
...
#define RX_FINFO_RXPSR_MASK                                                                        \
    0x000C0000UL /* RX Preamble Repetition. 00 = 16 symbols, 01 = 64 symbols, 10 = 1024 symbols,   \
                    11 = 4096 symbols */
...
#define RX_FINFO_RXBR_MASK                                                                         \
    0x00006000UL /* Receive Bit Rate report. This field reports the received bit rate */
...
#define RX_FINFO_RNG                                                                               \
    0x00008000UL /* Receiver Ranging. Ranging bit in the received PHY header identifying the frame \
                    as a ranging packet. */
...
#define RX_EQUAL_FP_AMPL2_MASK                                                                     \
    0xFFFF0000ULL /* First Path Amplitude point 2 - magnitude of 2nd point after Ceiling(FP_Index) \
                   */
...
/*offset 32*/
#define RX_EQUAL_FP_AMPL3_MASK                                                                     \
    0x0000FFFF00000000ULL /* First Path Amplitude point 3 - magnitude of 1st point after           \
                             Ceiling(FP_Index)  */
...
#define RX_TTCKO_MASK_32                                                                           \
    0xFF07FFFFUL /* Receiver Time Tracking Offset access mask (all unused fields should always be  \
                    writen as zero) */
/*offset 0 */
#define RX_TTCKO_RXTOFS_MASK                                                                       \
    0x0007FFFFUL /* RX time tracking offset. This RXTOFS value is a 19-bit signed quantity*/
/*offset 24 */
#define RX_TTCKO_RSMPDEL_MASK                                                                      \
    0xFF000000UL /* This 8-bit field reports an internal re-sampler delay value */
/*offset 32 */
#define RX_TTCKO_RCPHASE_MASK                                                                      \
    0x7F0000000000ULL /* This 7-bit field reports the receive carrier phase adjustment at time the \
                         ranging timestamp is made. */
...
#define RX_TIME_FP_AMPL1_OFFSET                                                                    \
    (7) /* byte 7..8 16 bit First Path Amplitude - magnitude of 3rd point after Ceiling(FP_Index)  \
         */
...
/****************************************************************************/ /**
                                                                                ...
                                                                                *register ACK_RESP_T
                                                                                **/
/* Acknowledge (31:24 preamble symbol delay before auto ACK is sent) and respose (19:0 - unit 1us)
 * timer */
...
#define RX_SNIFF_SNIFF_OFFT_MASK                                                                   \
    0x0000FF00UL /* SNIFF Mode OFF time specified in units of approximately 1mkS, or 128 system    \
                    clock cycles.*/
...
#define TX_POWER_TXPOWPHR_MASK                                                                     \
    0x0000FF00UL /* This power setting is applied during the transmission of the PHY header (PHR)  \
                    portion of the frame. */
#define TX_POWER_TXPOWSD_MASK                                                                      \
    0x00FF0000UL /* This power setting is applied during the transmission of the synchronisation   \
                    header (SHR) and data portions of the frame. */
...
#define CHAN_CTRL_RXFPRF_MASK                                                                      \
    0x000C0000UL /* Bits 18..19      Specify (Force) RX Pulse Repetition Rate: 00 = 4 MHz, 01 = 16 \
                    MHz, 10 = 64MHz. */
#define CHAN_CTRL_RXFPRF_SHIFT (18)
/* Specific RXFPRF configuration */
#define CHAN_CTRL_RXFPRF_4                                                                         \
    0x00000000UL /* Specify (Force) RX Pulse Repetition Rate: 00 = 4 MHz, 01 = 16 MHz, 10 = 64MHz. \
                  */
#define CHAN_CTRL_RXFPRF_16                                                                        \
    0x00040000UL /* Specify (Force) RX Pulse Repetition Rate: 00 = 4 MHz, 01 = 16 MHz, 10 = 64MHz. \
                  */
#define CHAN_CTRL_RXFPRF_64                                                                        \
    0x00080000UL /* Specify (Force) RX Pulse Repetition Rate: 00 = 4 MHz, 01 = 16 MHz, 10 = 64MHz. \
                  */
...
#define CHAN_CTRL_DWSFD                                                                            \
    0x00020000UL /* Bit 17 This bit enables a non-standard DecaWave proprietary SFD sequence. */
...
/* offset from AGC_CTRL_ID in bytes */
/* Please take care not to write other values to this register as doing so may cause the DW1000 to
 * malfunction */
...
#define AGC_STAT1_EDG1_MASK                                                                        \
    0x0007C0 /* This 5-bit gain value relates to input noise power measurement. */
...
#define EC_CTRL_MASK                                                                               \
    0x00000FFBUL /* sub-register 0x00 is the External clock synchronisation counter configuration  \
                    register */
...
#define EC_CTRL_WAIT_MASK                                                                          \
    0x000007F8UL /* Wait counter used for external transmit synchronisation and external timebase  \
                    reset */
/* offset from EXT_SYNC_ID in bytes */
...
#define EC_GOLP_MASK                                                                               \
    0x0000003FUL /* sub-register 0x08 is the External clock offset to first path 1 GHz counter,    \
                    EC_GOLP */
#define EC_GOLP_OFFSET_EXT_MASK                                                                    \
    0x0000003FUL /* This register contains the 1 GHz count from the arrival of the RMARKER and the \
                    next edge of the external clock. */
...
#define GDP0                                                                                       \
    GxP0 /* Direction Selection for GPIO0. 1 = input, 0 = output. Only changed if the GDM0 mask    \
            bit has a value of 1 for the write operation*/
...
#define GISEN0                                                                                     \
    GIRQx0 /* GPIO IRQ Sense selection GPIO0 input. Value 0 = High or Rising-Edge, 1 = Low or      \
              falling-edge.*/
...
#define GIMOD0                                                                                     \
    GIRQx0 /* GPIO IRQ Mode selection for GPIO0 input. Value 0 = Level sensitive interrupt. Value  \
...
#define GPIO_IBES_OFFSET                                                                           \
    0x1C /* sub-register 0x1C is the GPIO interrupt �Both Edge� selection register */
#define GPIO_IBES_LEN (4)
#define GPIO_IBES_MASK GPIO_IRQE_MASK /*  */
#define GIBES0                                                                                     \
    GIRQx0 /* GPIO IRQ �Both Edge� selection for GPIO0 input. Value 0 = GPIO_IMODE register    \
              selects the edge. Value 1 = Both edges trigger the interrupt. */
...
#define GICLR0                                                                                     \
    GIRQx0 /* GPIO IRQ latch clear for GPIO0 input. Write 1 to clear the GPIO0 interrupt latch.    \
...
#define GIDBE0                                                                                     \
    GIRQx0 /* GPIO IRQ de-bounce enable for GPIO0. Value 1 = de-bounce enabled. Value 0 =          \
              de-bounce disabled */
 ...
 * since this risks IC malfunction due to prolonged receiver activity in the event of false preamble
 * detection.
 */
...
#define RF_CONF_TXALLEN_MASK                                                                       \
    (RF_CONF_TXEN_MASK | RF_CONF_TXPOW_MASK | RF_CONF_PLLEN_MASK | RF_CONF_TXBLOCKSEN_MASK)
...
#define TC_PGCCTRL_TMEAS_MASK                                                                      \
    0x3C /* Mask to retrieve number of clock cycles over which to run PG cal counter */
...
#define FS_RES1_OFFSET                                                                             \
    0x00 /* reserved area. Please take care not to write to this area as doing so may cause the    \
...
#define FS_RES2_OFFSET                                                                             \
    0x0C /* reserved area. Please take care not to write to this area as doing so may cause the    \
            DW1000 to malfunction. */
...
#define FS_XTALT_MASK                                                                              \
    0x1F /* Crystal Trim. Crystals may be trimmed using this register setting to tune out errors,  \
            see 8.1 � IC Calibration � Crystal Oscillator Trim. */
#define FS_XTALT_MIDRANGE 0x10
/* offset from FS_CTRL_ID in bytes */
#define FS_RES3_OFFSET                                                                             \
    0x0F /* reserved area. Please take care not to write to this area as doing so may cause the    \
            DW1000 to malfunction. */
...
#define AON_WCFG_OFFSET                                                                            \
    0x00 /* used to control what the DW1000 IC does as it wakes up from low-power SLEEP or         \
            DEEPSLEEPstates. */
#define AON_WCFG_LEN (2)
#define AON_WCFG_MASK 0x09CB /* access mask to AON_WCFG register*/
#define AON_WCFG_ONW_RADC                                                                          \
    0x0001 /* On Wake-up Run the (temperature and voltage) Analog-to-Digital Convertors */
#define AON_WCFG_ONW_RX 0x0002 /* On Wake-up turn on the Receiver */
#define AON_WCFG_ONW_LEUI                                                                          \
    0x0008 /* On Wake-up load the EUI from OTP memory into Register file: 0x01 � Extended Unique \
              Identifier. */
...
#define AON_CTRL_OFFSET                                                                            \
    0x02 /* The bits in this register in general cause direct activity within the AON block with   \
            respect to the stored AON memory */
#define AON_CTRL_LEN (1)
#define AON_CTRL_MASK 0x8F /* access mask to AON_CTRL register */
#define AON_CTRL_RESTORE                                                                           \
    0x01 /* When this bit is set the DW1000 will copy the user configurations from the AON memory  \
            to the host interface register set. */
#define AON_CTRL_SAVE                                                                              \
    0x02 /* When this bit is set the DW1000 will copy the user configurations from the host        \
            interface register set into the AON memory */
...
#define AON_CFG0_LPCLKDIVA_MASK                                                                    \
    0x0000FFE0UL /* divider count for dividing the raw DW1000 XTAL oscillator frequency to set an  \
                    LP clock frequency */
#define AON_CFG0_LPCLKDIVA_SHIFT (5)
#define AON_CFG0_SLEEP_TIM                                                                         \
    0xFFFF0000UL /* Sleep time. This field configures the sleep time count elapse value */
...
#define AON_CFG1_SMXX                                                                              \
    0x0002 /* This bit needs to be set to 0 for correct operation in the SLEEP state within the    \
              DW1000 */
#define AON_CFG1_LPOSC_CAL                                                                         \
    0x0004 /* This bit enables the calibration function that measures the period of the IC�s     \
              internal low powered oscillator */
...
#define OTP_ADDR_MASK                                                                              \
    0x07FF /* This 11-bit field specifies the address within OTP memory that will be accessed read \
              or written. */
/* offset from OTP_IF_ID in bytes */
...
#define OTP_CTRL_OTPREAD                                                                           \
    0x0002 /* This bit commands a read operation from the address specified in the OTP_ADDR        \
              register */
#define OTP_CTRL_LDELOAD 0x8000 /* This bit forces a load of LDE microcode */
#define OTP_CTRL_OTPPROG                                                                           \
    0x0040 /* Setting this bit will cause the contents of OTP_WDAT to be written to OTP_ADDR. */
/* offset from OTP_IF_ID in bytes */
...
/* offset from OTP_IF_ID in bytes */
#define OTP_RDAT                                                                                   \
    0x0A /* 32-bit register. The data value read from an OTP location will appear here */
#define OTP_RDAT_LEN (4)
/* offset from OTP_IF_ID in bytes */
#define OTP_SRDAT                                                                                  \
    0x0E /* 32-bit register. The data value stored in the OTP SR (0x400) location will appear here \
            after power up */
#define OTP_SRDAT_LEN (4)
/* offset from OTP_IF_ID in bytes */
#define OTP_SF                                                                                     \
    0x12 /*8-bit special function register used to select and load special receiver operational    \
            parameter */
#define OTP_SF_LEN (1)
#define OTP_SF_MASK 0x63
#define OTP_SF_OPS_KICK                                                                            \
    0x01 /* This bit when set initiates a load of the operating parameter set selected by the      \
            OPS_SEL */
...
#define LDE_THRESH_OFFSET                                                                          \
    0x0000 /* 16-bit status register reporting the threshold that was used to find the first path  \
            */
...
#define LDE_PPINDX_OFFSET                                                                          \
    0x1000 /* reporting the position within the accumulator that the LDE algorithm has determined  \
              to contain the maximum */
#define LDE_PPINDX_LEN (2)
/* offset from LDE_IF_ID in bytes */
#define LDE_PPAMPL_OFFSET                                                                          \
    0x1002 /* reporting the magnitude of the peak signal seen in the accumulator data memory */
#define LDE_PPAMPL_LEN (2)
/* offset from LDE_IF_ID in bytes */
#define LDE_RXANTD_OFFSET                                                                          \
    0x1804 /* 16-bit configuration register for setting the receive antenna delay */
...
#define LDE_REPC_OFFSET                                                                            \
    0x2804 /* 16-bit configuration register for setting the replica avoidance coefficient */
...
#define EVC_CTRL_MASK                                                                              \
    0x00000003UL /* access mask to Register for bits should always be set to zero to avoid any     \
...
#define EVC_FFR_OFFSET                                                                             \
    0x0C /* The EVC_FFR field is a 12-bit counter of the frames rejected by the receive frame      \
            filtering function. */
...
#define EVC_PTO_OFFSET                                                                             \
    0x12 /* The EVC_PTO field is a 12-bit counter of Preamble detection Timeout events */
#define EVC_PTO_LEN (2)
#define EVC_PTO_MASK 0x0FFF

/* offset from DIG_DIAG_ID in bytes */
#define EVC_FWTO_OFFSET                                                                            \
    0x14 /* The EVC_FWTO field is a 12-bit counter of receive frame wait timeout events */
#define EVC_FWTO_LEN (2)
#define EVC_FWTO_MASK 0x0FFF
/* offset from DIG_DIAG_ID in bytes */
#define EVC_TXFS_OFFSET                                                                            \
    0x16 /* The EVC_TXFS field is a 12-bit counter of transmit frames sent. This is incremented    \
            every time a frame is sent */
...
#define EVC_TPW_OFFSET                                                                             \
    0x1A /* The EVC_TPW field is a 12-bit counter of �Transmitter Power-Up Warnings�. */
#define EVC_TPW_LEN (2)
#define EVC_TPW_MASK 0x0FFF

/* offset from DIG_DIAG_ID in bytes */
#define EVC_RES1_OFFSET                                                                            \
    0x1C /* Please take care not to write to this register as doing so may cause the DW1000 to     \
            malfunction. */
...
#define DIAG_TMC_TX_PSTM                                                                           \
    0x0010 /* This test mode is provided to help support regulatory approvals spectral testing.    \
              When the TX_PSTM bit is set it enables a repeating transmission of the data from the \
              TX_BUFFER */
...
#define PMSC_CTRL0_SYSCLKS_AUTO                                                                    \
    0x00000000UL /* The system clock will run off the 19.2 MHz XTI clock until the PLL is          \
...
#define PMSC_CTRL0_RXCLKS_AUTO                                                                     \
    0x00000000UL /* The RX clock will be disabled until it is required for an RX operation */
#define PMSC_CTRL0_RXCLKS_19M                                                                      \
    0x00000004UL /* Force RX clock enable and sourced clock from the 19.2 MHz XTI clock */
#define PMSC_CTRL0_RXCLKS_125M                                                                     \
    0x00000008UL /* Force RX clock enable and sourced from the 125 MHz PLL clock */
#define PMSC_CTRL0_RXCLKS_OFF 0x0000000CUL /* Force RX clock off. */
#define PMSC_CTRL0_TXCLKS_AUTO                                                                     \
    0x00000000UL /* The TX clock will be disabled until it is required for a TX operation */
#define PMSC_CTRL0_TXCLKS_19M                                                                      \
    0x00000010UL /* Force TX clock enable and sourced clock from the 19.2 MHz XTI clock */
#define PMSC_CTRL0_TXCLKS_125M                                                                     \
    0x00000020UL /* Force TX clock enable and sourced from the 125 MHz PLL clock */
...
#define PMSC_CTRL1_ATXSLP                                                                          \
    0x00000800UL /* If this bit is set then the DW1000 will automatically transition into SLEEP or \
                    DEEPSLEEP mode after transmission of a frame */
#define PMSC_CTRL1_ARXSLP                                                                          \
    0x00001000UL /* this bit is set then the DW1000 will automatically transition into SLEEP mode  \
                    after a receive attempt */
#define PMSC_CTRL1_SNOZE 0x00002000UL /* Snooze Enable */
#define PMSC_CTRL1_SNOZR                                                                           \
    0x00004000UL /* The SNOZR bit is set to allow the snooze timer to repeat twice */
#define PMSC_CTRL1_PLLSYN                                                                          \
    0x00008000UL /* This enables a special 1 GHz clock used for some external SYNC modes */
...
#define PMSC_CTRL1_PKTSEQ_DISABLE                                                                  \
    0x00 /* writing this to PMSC CONTROL 1 register (bits 10-3) disables PMSC control of analog RF \
            subsystems */
#define PMSC_CTRL1_PKTSEQ_ENABLE                                                                   \
    0xE7 /* writing this to PMSC CONTROL 1 register (bits 10-3) enables PMSC control of analog RF  \
            subsystems */
/* offset from PMSC_ID in bytes */
...
#define PMSC_LEDC_BLINK_TIM_MASK                                                                   \
    0x000000FFUL /* This field determines how long the LEDs remain lit after an event that causes  \
                    them to be set on. */
#define PMSC_LEDC_BLNKEN                                                                           \
    0x00000100UL /* Blink Enable. When this bit is set to 1 the LED blink feature is enabled. */
/* Default blink time. Blink time is expressed in multiples of 14 ms. The value defined here is ~225
 * ms. */
