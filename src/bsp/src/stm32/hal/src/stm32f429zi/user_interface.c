...
void UI_heartbeatCallback() { HAL_GPIO_TogglePin(LD1_GPIO_Port, LD1_Pin); }
...
void UI_setRGB(bool red, bool green, bool blue) {
    HAL_GPIO_WritePin(LD1_GPIO_Port, LD1_Pin, green ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LD2_GPIO_Port, LD2_Pin, blue ? GPIO_PIN_SET : GPIO_PIN_RESET);
