...
#define CHAN_DET_1_C_Pin GPIO_PIN_3
#define CHAN_DET_1_C_GPIO_Port GPIOA
...
#define MEZ_SPI_MISOE14_Pin GPIO_PIN_14
#define MEZ_SPI_MISOE14_GPIO_Port GPIOE
...
#define CHAN_IRQ_1B_Pin GPIO_PIN_8
...
#define CHN_RESET_0A_Pin GPIO_PIN_5
#define CHN_RESET_0A_GPIO_Port GPIOD
...
#define UART2_WROOM_RX_Pin GPIO_PIN_0
#define UART2_WROOM_RX_GPIO_Port GPIOE
