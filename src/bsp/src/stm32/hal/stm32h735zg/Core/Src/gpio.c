...
void MX_GPIO_Init(void) {
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, SPI_nCS_0C_Pin | WROOM_PWR_EN_Pin | SPI_ESP_nCS_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(
        GPIOD, SPI_nCS_1C_Pin | CHAN_EN_1B_Pin | SPI_nCS_1B_Pin | CHAN_EN_1A_Pin | SPI_nCS_1A_Pin,
        GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOG,
                      CH_CL_PWR_EN_Pin | CLK_OE_1__Pin | CLK_OE_0__Pin | CHAN_EN_0A_Pin |
                          SPI_nCS_0A_Pin | DEBUG_EN__Pin,
                      GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = PHY_nRST_Pin | CHAN_EN_0B_Pin | SYNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = SPI_nCS_0C_Pin | WROOM_PWR_EN_Pin | SPI_ESP_nCS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                             PDPin */
    GPIO_InitStruct.Pin =
        SPI_nCS_1C_Pin | CHAN_EN_1B_Pin | SPI_nCS_1B_Pin | CHAN_EN_1A_Pin | SPI_nCS_1A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pins : PGPin PGPin PGPin PGPin
                             PGPin PGPin */
    GPIO_InitStruct.Pin = CH_CL_PWR_EN_Pin | CLK_OE_1__Pin | CLK_OE_0__Pin | CHAN_EN_0A_Pin |
                          SPI_nCS_0A_Pin | DEBUG_EN__Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pin : PtPin */
    GPIO_InitStruct.Pin = DEBUG_PWR_EN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DEBUG_PWR_EN_GPIO_Port, &GPIO_InitStruct);
