...
foreach(COMP ${LWIP_FIND_COMPONENTS})
    ...
    if (NOT (TARGET CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::IPV4))
        ...
        target_include_directories(CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::IPV4 INTERFACE "${lwip_INC}")
    ...
    if (NOT (TARGET CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::IPV6))
        ...
        target_include_directories(CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::IPV6 INTERFACE "${lwip_INC}")
    ...
    if (NOT (TARGET CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::PPP))
        ...
        target_include_directories(CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::PPP INTERFACE "${lwip_INC}")
    ...
    if (NOT (TARGET CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::6LoWPAN))
        ...
        target_include_directories(CMSIS::STM32::${FAMILY}${CORE_C}::LWIP::6LoWPAN INTERFACE "${lwip_INC}")
